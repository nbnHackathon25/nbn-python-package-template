...
description: 'Guidelines for creating high-quality custom instruction files for GitHub Copilot. Sourced (and modified) from: https://github.com/github/awesome-copilot/blob/main/instructions/instructions.instructions.md'
---
...
description: 'Brief description of the instruction purpose and scope. Sourced from: (relevant source URL)'
---
```
