...
target: vscode
name: 'clean-code'
description: 'Agent for understanding writing clean, readable, and maintainable code following established coding guidelines. Sourced and updated from: https://github.com/Code-and-Sorts/awesome-copilot-agents/tree/main/chatmodes/ai-development-mode'
tools: ['runNotebooks', 'search', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos']
handoffs:
  - label: beast-mode
    agent: beast-mode
    prompt: Now implement the code following clean code principles.
    send: false
---
