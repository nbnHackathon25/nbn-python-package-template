...
target: vscode
name: 'architect'
description: 'Agent to design and plan software systems, including defining components, interactions, and technologies. Sourced from: https://github.com/Code-and-Sorts/awesome-copilot-agents/tree/main/chatmodes/ai-development-mode'
tools: ['search/codebase', 'fetch', 'todos']
handoffs:
  - label: clean-code
    agent: clean-code
    prompt: Now consider how to implement this architecture with clean, maintainable code.
    send: false
---
