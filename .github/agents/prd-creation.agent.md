...
target: vscode
name: 'prd-creation'
description: 'Agent for creating comprehensive Product Requirements Documents (PRDs) by transforming feature ideas into detailed specifications. Sourced (and modified) from: https://github.com/Code-and-Sorts/awesome-copilot-agents/tree/main/chatmodes/ai-development-mode'
argument-hint: 'eg. I want to add user authentication to my app'
tools: ['edit/createFile', 'edit/createDirectory', 'edit/editFiles', 'search', 'usages', 'vscodeAPI', 'problems', 'fetch', 'githubRepo', 'todos']
handoffs:
  - label: architect
    agent: architect
    prompt: Now design the architecture for this feature (if required).
    send: false
---

# PRD Creation

> Please do not make any edits to the files except for the PRD file itself (if required).
